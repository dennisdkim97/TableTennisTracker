		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#tabletennistrackertabletennistracker-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tabletennistrackertabletennistracker-display": {
								"semanticObject": "tabletennistrackertabletennistracker",
								"action": "display",
								"description": "Table Tennis Score Tracker and Leaderboard",
								"title": "Table Tennis Tracker",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tabletennistracker.tabletennistracker",
									"url": sap.ui.require.toUrl("tabletennistracker/tabletennistracker")
								}
							}
						}
					}
